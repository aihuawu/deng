...
address 0xa9876 {
	...
	module amoeba_sbu_score_matrix {
		// use Std::Signer;
		...
		struct Ty_project_key has copy, drop, store { 
			account_address: address,
			evaluation_event_time: u128,
		}
		
		struct Ty_project_score_entry has copy, drop, store { 
		...
		struct Ty_project_score_table has key {
			rows: amoeba_map::T<Ty_project_key, Ty_project_score_entry>,
		}
		...
		fun make_project_score(): Ty_project_score_entry
		{
			Ty_project_score_entry {
